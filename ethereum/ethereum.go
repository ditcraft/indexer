...
func getDitCoordinatorInstance(_connection *ethclient.Client, _live bool) (*ditCoordinator.DitCoordinator, error) {
	...
	if _live {
		ditCoordinatorAddress = common.HexToAddress(os.Getenv("CONTRACT_DIT_COORDINATOR_LIVE_V2"))
	} else {
		ditCoordinatorAddress = common.HexToAddress(os.Getenv("CONTRACT_DIT_COORDINATOR_DEMO_V2"))
	}
